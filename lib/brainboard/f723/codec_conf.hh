#pragma once
// FIXME: depends on project audio_stream_conf (sample rate, etc)
// Options:
// 1) Move audio_stream_conf.hh to lib/brainboard
// 2) Define sai_conf in a project conf file, using Brain::Pin:: and Brain::SAIx etc
// 3) Move codec_conf.hh back to project
